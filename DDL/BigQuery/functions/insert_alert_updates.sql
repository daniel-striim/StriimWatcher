...
--   which match what is actually running in the live PROD implementation (view + single MERGE,
--   with a QUALIFY dedup fix and updated tuning constants). Kept here for reference/rollback only;
--   do not schedule this procedure for new deployments.
